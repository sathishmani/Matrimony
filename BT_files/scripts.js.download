...
var mr = function (a, b, c) {
    ...
    function d(b) { b = "undefined" == typeof b ? a : b, g.documentReady.concat(g.documentReadyDeferred).forEach(function (a) { a(b) }) }

    function e(b) { b = "object" == typeof b ? a : b, g.windowLoad.concat(g.windowLoadDeferred).forEach(function (a) { a(b) }) }
    var f = {},
        g = { documentReady: [], documentReadyDeferred: [], windowLoad: [], windowLoadDeferred: [] };
...
mr = function (a, b, c, d) {
    ...
    return a.util = {}, a.util.requestAnimationFrame = c.requestAnimationFrame || c.mozRequestAnimationFrame || c.webkitRequestAnimationFrame || c.msRequestAnimationFrame, a.util.documentReady = function (a) {
        ...
        var d = b(a),
            ...
            }), d.empty(), b(e).each(function (a, b) { d.append(b) })
        ...
        d.each(function (a, c) {
            c = b(c);
            var d = c.attr("data-src"); "undefined" != typeof d && c.attr("src", d)
        })
    ...
    "use strict";
    return a.window = {}, a.window.height = b(c).height(), a.window.width = b(c).width(), b(c).on("resize", function () { a.window.height = b(c).height(), a.window.width = b(c).width() }), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    a.scroll = {}, a.scroll.listeners = [], a.scroll.y = 0, a.scroll.x = 0;
    var e = function (b) { b("body").hasClass("scroll-assist") && (a.scroll.assisted = !0), addEventListener("scroll", function (a) { c.mr.scroll.y = c.pageYOffset, c.mr.scroll.update(a) }, !1) };
    ...
    return a.accordions = { documentReady: e }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    var e = function (a) {
    ...
    return a.backgrounds = { documentReady: e }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    var e = function (a) {
    ...
    return a.bars = { documentReady: e }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    return a.cookies = {
        getItem: function (a) {
    ...
    var e = function (a) {
        a(".countdown[data-date]").each(function () {
            var b, c = a(this),
                d = c.attr("data-date"),
                e = "days"; "undefined" != typeof c.attr("data-date-fallback") && (b = c.attr("data-date-fallback")), "undefined" != typeof c.attr("data-days-text") && (e = c.attr("data-days-text")), c.countdown(d, function (a) { a.elapsed ? c.text(b) : c.text(a.strftime("%D " + e + " %H:%M:%S")) })
        })
    };
    return a.countdown = { documentReady: e }, a.components.documentReadyDeferred.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    var e = function (a) { a(".datepicker").length && a(".datepicker").pickadate() };
    ...
    function e(a) {
        a(".dropdown__container").each(function () {
            var a = jQuery(this),
                ...
                e = "";
            a.css("left", -b + c), a.find('.dropdown__content:not([class*="md-12"])').length && (e = a.find(".dropdown__content"), e.css("left", d - c))
    ...
    function f(a) {
        ...
        a(".dropdown__container").each(function () {
            var a = jQuery(this),
                ...
                f = "";
            a.css("right", -c + d), a.find('.dropdown__content:not([class*="md-12"])').length && (f = a.find(".dropdown__content"), f.css("right", e - d))
        }), a(".dropdown__content").each(function () {
            var a = jQuery(this),
    ...
    var g = function (b) {
        ...
        }), jQuery(d).on("click touchstart", "body", function (a) { jQuery(a.target).is('[class*="dropdown"], [class*="dropdown"] *') || b(".dropdown--active").removeClass("dropdown--active") }), jQuery("body").append('<div class="container containerMeasure" style="opacity:0;pointer-events:none;"></div>'), a.dropdowns.done = !0), g === !1 ? e(b) : f(b), jQuery(c).resize(function () { })
    };
    ...
    var e = function (b) {
        b(".input-checkbox").on("click", function () {
            ...
            if (!b(a.target).is("input")) {
                ...
                return c.closest("form").find("[type=radio][name*=" + d.replace(/\[[^\]]*\]/g, "") + "]").each(function () { b(this).parent().removeClass("checked") }), c.addClass("checked").find("input").click().prop("checked", !0), !1
            }
        ...
        }), b('form.form-email, form[action*="list-manage.com"], form[action*="createsend.com"]').attr("novalidate", !0).off("submit").on("submit", a.forms.submit), b(d).on("change, input, paste, keyup", ".attempted-submit .field-error", function () { b(this).removeClass("field-error") })
    };
    return a.forms.documentReady = e, a.forms.submit = function (d) {
        ...
        if (j.find(".form-error, .form-success").remove(), m.attr("data-text", m.text()), h = k.attr("data-error") ? k.attr("data-error") : "Please fill all fields correctly", i = k.attr("data-success") ? k.attr("data-success") : "Thanks, we'll be in touch shortly", j.append('<div class="form-error" style="display: none;">' + h + "</div>"), j.append('<div class="form-success" style="display: none;">' + i + "</div>"), f = j.find(".form-error"), g = j.find(".form-success"), k.addClass("attempted-submit"), -1 !== l.indexOf("createsend.com") || -1 !== l.indexOf("list-manage.com"))
            if ("undefined" != typeof o && o !== !1 && f.html(o), 1 !== a.forms.validateFields(k)) {
                ...
                try { b.ajax({ url: k.attr("action"), crossDomain: !0, data: k.serialize(), method: "GET", cache: !1, dataType: "json", contentType: "application/json; charset=utf-8", success: function (b) { "success" !== b.result && 200 !== b.Status ? (f.attr("original-error", f.text()), f.html(b.msg).stop(!0).fadeIn(1e3), g.stop(!0).fadeOut(1e3), m.removeClass("btn--loading")) : (m.removeClass("btn--loading"), e = k.attr("data-success-redirect"), "undefined" != typeof e && e !== !1 && "" !== e ? c.location = e : (a.forms.resetForm(k), a.forms.showFormSuccess(g, f, 1e3, 5e3, 500))) } }) } catch (p) { f.attr("original-error", f.text()), f.html(p.message), a.forms.showFormError(g, f, 1e3, 5e3, 500), m.removeClass("btn--loading") }
            } else a.forms.showFormError(g, f, 1e3, 5e3, 500);
        else "undefined" != typeof o && o !== !1 && f.text(o), n = a.forms.validateFields(k), 1 === n ? a.forms.showFormError(g, f, 1e3, 5e3, 500) : (k.removeClass("attempted-submit"), f.fadeOut(200), m.addClass("btn--loading"), jQuery.ajax({ type: "POST", url: "http://mailform.mediumra.re/stack/mail.php", data: k.serialize() + "&url=" + c.location.href, success: function (d) { m.removeClass("btn--loading"), b.isNumeric(d) ? parseInt(d, 10) > 0 && (e = k.attr("data-success-redirect"), "undefined" != typeof e && e !== !1 && "" !== e && (c.location = e), a.forms.resetForm(k), a.forms.showFormSuccess(g, f, 1e3, 5e3, 500)) : (f.attr("original-error", f.text()), f.text(d).stop(!0).fadeIn(1e3), g.stop(!0).fadeOut(1e3)) }, error: function (a, b, c) { f.attr("original-error", f.text()), f.text(c).stop(!0).fadeIn(1e3), g.stop(!0).fadeOut(1e3), m.removeClass("btn--loading") } }));
        return !1
    ...
    var e = function (a) {
        a("[data-gradient-bg]").each(function (b, c) {
            ...
            a(this), new Granim({ element: "#" + h, name: "basic-gradient", direction: "left-right", opacity: [1, 1], isPausedWhenNotInView: !0, states: { "default-state": { gradients: j } } })
        })
    };
    return a.granim = { documentReady: e }, a.components.documentReadyDeferred.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    var e = function (a) {
        if (a(".instafeed").length) {
            ...
            a(".instafeed[data-access-token][data-client-id]").length && (b = a(".instafeed[data-access-token][data-client-id]").first().attr("data-access-token"), c = a(".instafeed[data-access-token][data-client-id]").first().attr("data-client-id"), "" !== b && (d = b), "" !== c && (e = c)), jQuery.fn.spectragram.accessData = { accessToken: d, clientID: e }
        }
        a(".instafeed").each(function () {
            var b = a(this),
                c = b.attr("data-user-name"),
                d = 12; "undefined" != typeof b.attr("data-amount") && (d = parseInt(b.attr("data-amount"), 10)), b.append("<ul></ul>"), b.children("ul").spectragram("getUserFeed", { query: c, max: d })
        })
    };
    return a.instagram = { documentReady: e }, a.components.documentReadyDeferred.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    a.maps = {};
    var e = function (b) {
        b(".map-holder").on("click", function () { b(this).addClass("interact") }).removeClass("interact");
    ...
    return a.maps.documentReady = e, a.maps.initAPI = function (a) {
        ...
        "undefined" != typeof c.google && "undefined" != typeof c.google.maps && jQuery(".gmaps-active").each(function () {
            var a, b, e = this,
                ...
                r = { draggable: q, scrollwheel: !1, zoom: i, disableDefaultUI: !0, styles: h }; "undefined" != typeof f.attr("data-marker-title") && "" !== f.attr("data-marker-title") && (p = f.attr("data-marker-title")), void 0 !== n && "" !== n[0] ? m.geocode({ address: n[0].replace("[nomarker]", "") }, function (a, b) {
                    if (b === google.maps.GeocoderStatus.OK) {
                        var d = new google.maps.Map(e, r);
                        d.setCenter(a[0].geometry.location), n.forEach(function (a) {
                            var b;
                            if (o = { url: "undefined" == typeof c.mr_variant ? "object" != typeof o ? o : o.url : "../img/mapmarker.png", scaledSize: new google.maps.Size(50, 50) }, /(\-?\d+(\.\d+)?),\s*(\-?\d+(\.\d+)?)/.test(a)) var e = a.split(","),
                                f = new google.maps.Marker({ position: { lat: 1 * e[0], lng: 1 * e[1] }, map: d, icon: o, title: p, optimised: !1 });
                            else a.indexOf("[nomarker]") < 0 && (b = new google.maps.Geocoder, b.geocode({ address: a.replace("[nomarker]", "") }, function (a, b) { b === google.maps.GeocoderStatus.OK && (f = new google.maps.Marker({ map: d, icon: o, title: p, position: a[0].geometry.location, optimised: !1 })) }))
                        })
                    }
                }) : "undefined" != typeof k && "" !== k && k !== !1 && "undefined" != typeof l && "" !== l && l !== !1 && (r.center = { lat: k, lng: l }, a = new google.maps.Map(f, r), b = new google.maps.Marker({ position: { lat: k, lng: l }, map: a, icon: o, title: p }))
        })
        ...
        b(".masonry").each(function () {
            ...
            e.find(".masonry__item[data-masonry-filter]").length && (f.append("<ul></ul>"), c = f.find("> ul"), e.find(".masonry__item[data-masonry-filter]").each(function () {
                var d = b(this),
                    ...
                    f = []; "undefined" != typeof e && "" !== e && (f = e.split(",")), jQuery(f).each(function (b, e) {
            ...
            var a = b(this),
                ...
                d = "*"; "*" !== a.attr("data-masonry-filter") && (d = ".filter-" + a.attr("data-masonry-filter")), a.siblings("li").removeClass("active"), a.addClass("active"), c.removeClass("masonry--animate"), c.on("layoutComplete", function () { b(this).addClass("masonry--active"), "undefined" != typeof mr_parallax && setTimeout(function () { mr_parallax.profileParallaxElements() }, 100) }), c.isotope({ filter: d })
        })
    },
        f = function () {
            b(".masonry").each(function () {
                var a = b(this).find(".masonry__container"),
                    c = b(this),
                    d = "*";
                c.is("[data-default-filter]") && (d = c.attr("data-default-filter").toLowerCase(), d = ".filter-" + d, c.find("li[data-masonry-filter]").removeClass("active"), c.find('li[data-masonry-filter="' + c.attr("data-default-filter").toLowerCase() + '"]').addClass("active")), a.on("layoutComplete", function () { a.addClass("masonry--active"), "undefined" != typeof mr_parallax && setTimeout(function () { mr_parallax.profileParallaxElements() }, 100) }), a.isotope({ itemSelector: ".masonry__item", filter: d, masonry: { columnWidth: ".masonry__item" } })
            })
        };
    return a.masonry = { documentReady: e, windowLoad: f }, a.components.documentReady.push(e), a.components.windowLoad.push(f), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    a.modals = {};
    var e = function (b) {
        ...
        if (f.length ? (jQuery(e).insertAfter(f), a.modals.allModalsContainer = b("div.all-page-modals")) : (jQuery("body").append(e), a.modals.allModalsContainer = jQuery("body div.all-page-modals")), b(".modal-container").each(function () {
        ...
        }), jQuery(d).on("click", ".modal-close", a.modals.closeActiveModal), jQuery(d).keyup(function (b) { 27 === b.keyCode && a.modals.closeActiveModal() }), b(".modal-container").on("click", function (b) { b.target === this && a.modals.closeActiveModal() }), b(".modal-container[data-autoshow]").each(function () {
            var c = b(this),
            ...
            var c = jQuery(this),
                ...
                f = 0;
            c.attr("data-delay") && (f = parseInt(c.attr("data-delay"), 10) || 0), b(e).length && (c.prepend(b('<i class="ti-close close-modal">')), jQuery(d).on("mouseleave", e, function () { b(".modal-active").length || ("undefined" != typeof c.attr("data-cookie") ? a.cookies.hasItem(c.attr("data-cookie")) || a.modals.showModal(c, f) : a.modals.showModal(c, f)) }))
        ...
        b(d).on("wheel mousewheel scroll", ".modal-content, .modal-content .scrollable", function (a) { a.preventDefault && a.preventDefault(), a.stopPropagation && a.stopPropagation(), this.scrollTop += a.originalEvent.deltaY })
    };
    return a.modals.documentReady = e, a.modals.showModal = function (a, c) {
        var d = "undefined" != typeof c ? 1 * c : 0;
        setTimeout(function () { b(a).addClass("modal-active") }, d)
    ...
    var e = function (b) {
        ...
        b('form[action*="createsend.com"]').each(function () {
            ...
            }), c.find("select").wrap('<div class="input-select"></div>'), c.find('input[type="radio"]').wrap('<div class="input-radio"></div>'), c.find('input[type="checkbox"]').each(function () { d = b(this), f = d.attr("id"), e = c.find("label[for=" + f + "]"), d.before('<div class="input-checkbox" data-id="' + f + '"></div>'), b('.input-checkbox[data-id="' + f + '"]').prepend(d), b('.input-checkbox[data-id="' + f + '"]').prepend(e), b('.input-checkbox[data-id="' + f + '"]').prepend('<div class="inner"></div>') }), c.find('button[type="submit"]').each(function () {
                var a = b(this);
            ...
            }), c.find("select").wrap('<div class="input-select"></div>'), c.find('input[type="checkbox"]').each(function () { d = b(this), g = d.parent(), e = g.find("label"), d.before('<div class="input-checkbox"><div class="inner"></div></div>'), g.find(".input-checkbox").append(d), g.find(".input-checkbox").append(e) }), c.find('input[type="radio"]').each(function () { h = b(this), g = h.closest("li"), e = g.find("label"), h.before('<div class="input-radio"><div class="inner"></div></div>'), g.find(".input-radio").prepend(h), g.find(".input-radio").prepend(e) }), c.find('input[type="submit"]').each(function () {
                var a = b(this),
            ...
            }), c.find('input[type="email"]').removeClass("email").addClass("validate-email"), c.find("#mce-responses").remove(), c.find(".mc-field-group").each(function () { b(this).children().first().unwrap() }), c.find("[required]").attr("required", "required").addClass("validate-required"), c.addClass("form--active"), a.newsletters.prepareAjaxAction(c)
    ...
    return a.notifications.documentReady = e, a.notifications.showNotification = function (b, c) {
        var d = "undefined" != typeof c ? 1 * c : 0;
        if (setTimeout(function () { b.addClass("notification--reveal"), b.closest("nav").addClass("notification--reveal"), b.find("input").length && b.find("input").first().focus() }, d), b.is("[data-autohide]")) {
            var e = parseInt(b.attr("data-autohide"), 10);
            setTimeout(function () { a.notifications.closeNotification(b) }, e + d)
        }
    ...
    return a.parallax = { documentReady: e }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    ...
    var e = function (b) {
        ...
        }, a.easypiecharts.activate = function () { a.easypiecharts.pies.forEach(function (b) { Math.round(a.scroll.y + a.window.height) >= Math.round(b.top + b.height) && b.active === !1 && (b.element.data("easyPieChart").enableAnimation(), b.element.data("easyPieChart").update(b.value), b.element.addClass("radial--active"), b.active = !0) }) }, b(".radial").each(function () {
            var a = jQuery(this),
                b = "#000000",
                c = 2e3,
                d = 110,
                e = 3; "undefined" != typeof a.attr("data-timing") && (c = 1 * a.attr("data-timing")), "undefined" != typeof a.attr("data-color") && (b = a.attr("data-color")), "undefined" != typeof a.attr("data-size") && (d = a.attr("data-size")), "undefined" != typeof a.attr("data-bar-width") && (e = a.attr("data-bar-width")), a.css("height", d).css("width", d), a.easyPieChart({ animate: { duration: c, enabled: !0 }, barColor: b, scaleColor: !1, size: d, lineWidth: e }), a.data("easyPieChart").update(0)
    ...
    var e = function (b) {
        b(".slider").each(function (c) {
            ...
            g = "true" === d.attr("data-arrows") ? !0 : !1, j = "false" === d.attr("data-autoplay") ? !1 : !0, h = "true" === d.attr("data-paging") && e.find("li").length > 1 ? !0 : !1, d.attr("data-timing") && (i = 1 * d.attr("data-timing")), d.attr("data-children", f), 2 > f && (k = !1), b(e).flickity({ cellSelector: ".slide", cellAlign: "left", wrapAround: !0, pageDots: h, prevNextButtons: g, autoPlay: i, draggable: k, imagesLoaded: !0 }), b(e).on("scroll.flickity", function (a, b) { d.find(".is-selected").hasClass("controls--dark") ? d.addClass("controls--dark") : d.removeClass("controls--dark") })
        })
    };
    ...
    }, a.smoothscroll.highlight = function () { a.smoothscroll.sections.forEach(function (b) { a.scroll.y >= b.top && a.scroll.y < b.top + b.height ? b.active === !1 && (b.link.classList.add("inner-link--active"), b.active = !0) : (b.link.classList.remove("inner-link--active"), b.active = !1) }) }, a.scroll.listeners.push(a.smoothscroll.highlight);
    var e = function (b) {
        ...
        if (d.length) {
            ...
            var e = 0;
            b("body[data-smooth-scroll-offset]").length && (e = b("body").attr("data-smooth-scroll-offset"), e = 1 * e), smoothScroll.init({ selector: ".inner-link", selectorHeader: null, speed: 750, easing: "easeInOutCubic", offset: e })
        }
    };
    ...
    return a.toggleClass = { documentReady: e }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    var e = function (a) {
        a(".typed-text").each(function () {
            ...
            a(b).typed({ strings: c, typeSpeed: 100, loop: !0, showCursor: !1 })
        })
    };
    return a.typed = { documentReady: e }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    var e = function (b) {
        b(".tweets-feed").each(function (a) { b(this).attr("id", "tweets-" + a) }).each(function (c) {
            function d(b) {
            ...
            var e = b("#tweets-" + c),
                f = { domId: "", maxTweets: e.attr("data-amount"), enableLinks: !0, showUser: !0, showTime: !0, dateFunction: "", showRetweet: !1, customCallback: d }; "undefined" != typeof e.attr("data-widget-id") ? f.id = e.attr("data-widget-id") : "undefined" != typeof e.attr("data-feed-name") && "" !== e.attr("data-feed-name") ? f.profile = { screenName: e.attr("data-feed-name").replace("@", "") } : f.profile = { screenName: "twitter" }, e.closest(".twitter-feed--slider").length && e.addClass("slider"), twitterFetcher.fetch(f)
        })
    };
    return a.twitter = { documentReady: e }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    var e = function (a) {
        a(".youtube-background").length && a(".youtube-background").each(function () {
            ...
            b.attr("data-property", '{videoURL:"' + c + '",containment:"self",autoPlay:true, mute:true, startAt:' + d + ", opacity:1}"), b.closest(".videobg").append('<div class="loading-indicator"></div>'), b.YTPlayer(), b.on("YTPStart", function () { b.closest(".videobg").addClass("video-active") })
    ...
    return a.video = { documentReady: e }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document), mr = function (a, b, c, d) {
    "use strict";
    var e = function (a) {
        a(".wizard").each(function () {
            var a = jQuery(this);
            a.steps({ headerTag: "h5", bodyTag: "section", transitionEffect: "slideLeft", autoFocus: !0 })
        })
    };
    return a.wizard = { documentReady: e }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document),
    function (a, b, c, d, e, f, g) {
        a.GoogleAnalyticsObject = e, a[e] = a[e] || function () {
            (a[e].q = a[e].q || []).push(arguments)
        }, a[e].l = 1 * new Date, f = b.createElement(c), g = b.getElementsByTagName(c)[0], f.async = 1, f.src = d, g.parentNode.insertBefore(f, g)
    }(window, document, "script", "https://www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-99169489-3", "auto"), ga("send", "pageview");
